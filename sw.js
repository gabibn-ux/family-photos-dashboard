...
const CACHE = "family-photos-v24";
const PRECACHE = [
  "/family-photos-dashboard/",
  "/family-photos-dashboard/gallery.js?v=24",
  "/family-photos-dashboard/gallery.css?v=24",
  "/family-photos-dashboard/static/index.json?v=24",
