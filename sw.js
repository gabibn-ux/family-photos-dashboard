...
const CACHE = "family-photos-v22";
const PRECACHE = [
  "/family-photos-dashboard/",
  "/family-photos-dashboard/gallery.js?v=22",
  "/family-photos-dashboard/gallery.css?v=22",
  "/family-photos-dashboard/static/index.json?v=22",
