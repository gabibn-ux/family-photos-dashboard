...
const CACHE = "family-photos-v15";
const PRECACHE = [
  "/family-photos-dashboard/",
  "/family-photos-dashboard/gallery.js?v=15",
  "/family-photos-dashboard/gallery.css?v=15",
  "/family-photos-dashboard/static/index.json?v=15",
